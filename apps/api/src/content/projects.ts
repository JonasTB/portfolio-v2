...
/**
 * Fonte de verdade dos projetos (ETAPA 08).
 *
 * Só existe um projeto real aqui: este próprio portfólio. Os demais campos
 * de "possíveis categorias" do PRODUCT_BRIEF.md (professional, open-source,
 * experiment) ficam sem exemplo até que haja conteúdo real — nada foi
 * inventado para preencher espaço (ver decisão da ETAPA 08).
 *
 * O case study é genuinamente preciso: cada decisão e desafio descritos
 * aqui aconteceu de verdade durante a construção deste site via Claude Code.
 */
